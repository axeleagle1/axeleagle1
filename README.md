...
`AI Systems` · `Full-Stack` · `Philippines` · `he/him`
...
I build systems at the intersection of **AI**, **finance**, and **human experience** — tools that are intelligent by design, empathetic by default.

> *"The real challenge is not capability — it is alignment."*
...
**HumankindAI** exists to make sure intelligence evolves with empathy — not just capability.

The goal isn't to replace human relationships. It's to provide **presence**, **clarity**, and **intelligent support** when someone needs it most.
...
![AI/ML](https://img.shields.io/badge/AI%2FML-8B5CF6?style=flat-square&logoColor=white)
